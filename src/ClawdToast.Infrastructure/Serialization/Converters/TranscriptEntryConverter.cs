...
namespace ClawdToast.Infrastructure.Serialization.Converters;

public sealed class TranscriptEntryConverter : JsonConverter<BaseTranscriptEntry>
{
    public override BaseTranscriptEntry? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return (type, subtype) switch
        {
            ...
            (InfrastructureShared.AiTitleMarker, _) => JsonSerializer.Deserialize(ref reader, context.AiTitleTranscriptEntry),
